...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.AliyunMachineClass": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "AliyunMachineClass TODO",
					Properties: map[string]spec.Schema{
						"metadata": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"),
						...
						"spec": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.AliyunMachineClassSpec"),
							},
						},
					},
				},
			...
			Dependencies: []string{
				"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.AliyunMachineClassSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
		},
		"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.AliyunMachineClassList": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "AliyunMachineClassList is a collection of AliyunMachineClasses.",
					Properties: map[string]spec.Schema{
						"kind": {
							SchemaProps: spec.SchemaProps{
								Description: "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds",
						...
						"items": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.AliyunMachineClass"),
										},
									},
								},
							},
			...
			Dependencies: []string{
				"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.AliyunMachineClass", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
		},
		"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.AliyunMachineClassSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "AliyunMachineClassSpec is the specification of a cluster.",
					Properties: map[string]spec.Schema{
						"imageId": {
							SchemaProps: spec.SchemaProps{
								Type:   []string{"string"},
						...
						"systemDisk": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.AliyunSystemDisk"),
							},
						},
						"instanceChargeType": {
							SchemaProps: spec.SchemaProps{
						...
						"tags": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.AliyunTags"),
							},
						},
						"keyPairName": {
							SchemaProps: spec.SchemaProps{
			...
			Dependencies: []string{
				"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.AliyunSystemDisk", "github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.AliyunTags", "k8s.io/api/core/v1.SecretReference"},
		},
		"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.AliyunSystemDisk": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "AliyunSystemDisk describes SystemDisk for Aliyun.",
					Properties: map[string]spec.Schema{
						"category": {
							SchemaProps: spec.SchemaProps{
								Type:   []string{"string"},
		...
		"github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha1.AliyunTags": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "AliyunTags describes Tags for Aliyun",
					Properties: map[string]spec.Schema{
						"tag1Key": {
							SchemaProps: spec.SchemaProps{
								Type:   []string{"string"},
